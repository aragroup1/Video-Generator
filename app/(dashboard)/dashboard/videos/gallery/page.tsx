...
import {
  Video, Download, Play, Pause, Filter, Search,
  Calendar, TrendingUp, Eye, Share2, Copy, Check
} from 'lucide-react';
...
export default function VideoGallery({ projectId, initialVideos = [] }: VideoGalleryProps) {
  ...
  const handleBulkDownload = async () => {
    const selectedVideos = videos.filter(v => v.isSelected);
  ...
  const getVideoTypeColor = (type: string) => {
    const colors: Record<string, string> = {
      '360_rotation': 'bg-purple-100 text-purple-700',
      'lifestyle_casual': 'bg-blue-100 text-blue-700',
      'lifestyle_premium': 'bg-amber-100 text-amber-700',
      'ad_testimonial': 'bg-green-100 text-green-700',
      'ad_feature_focus': 'bg-red-100 text-red-700',
      'ad_problem_solution': 'bg-indigo-100 text-indigo-700',
      'how_to_use': 'bg-pink-100 text-pink-700',
    };
      ...
      <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-200">
        <div className="flex flex-wrap gap-4">
          ...
          >
            ...
            <option value="360_rotation">360° Rotation</option>
            <option value="lifestyle_casual">Lifestyle Casual</option>
            <option value="lifestyle_premium">Lifestyle Premium</option>
            <option value="ad_testimonial">Ad Testimonial</option>
            <option value="ad_feature_focus">Ad Feature Focus</option>
            <option value="ad_problem_solution">Ad Problem Solution</option>
...
// API endpoint: /api/videos/[id]/download
export async function POST(
  ...
  try {
    ...
    const downloadUrl = await getSignedDownloadUrl(video.fileUrl, 3600);
